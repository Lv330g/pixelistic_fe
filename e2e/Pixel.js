module.exports = {
    'Pixel' :  (browser) => {
      browser
        .url('http://ec2-35-180-74-170.eu-west-3.compute.amazonaws.com')
        ...
        .pause(1000)
        .click('#menu-list-grow ul li:first-child')
        ...
        .click('.extension-icon')
        .pause(2000)
        .click('#menu-list-grow ul a:nth-child(3) li')
        ...
        .click('.extension-icon')
        .pause(1000)
        .click('#menu-list-grow ul a:nth-child(2) li')
        .waitForElementVisible('.post',10000)
        .pause(2000)
